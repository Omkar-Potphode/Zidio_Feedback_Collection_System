...
// Feedback APIs
export const ADD_SITE_RATING = `${HOST}/api/feeback/addSiteRating`;
export const ADD_SITE_FEEDBACK = `${HOST}/api/feeback/addSiteFeedback`;
export const ADD_SITE_BUG = `${HOST}/api/feeback/addSiteBug`;
